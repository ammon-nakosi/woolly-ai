...
class CounselSetup {
  async run() {
    ...
    console.log('  3. Create your first counsel work in Claude: ' + chalk.bold('/counsel-create feature "your feature"'));
    console.log('\nDocumentation: https://github.com/yourusername/counsel-framework');
  }
